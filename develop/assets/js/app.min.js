...
!function(a,b){"object"==typeof exports&&"undefined"!=typeof module?b(require("d3"),require("d3fc"),require("d3fc-rebind"),require("jquery")):"function"==typeof define&&define.amd?define(["d3","d3fc","d3fc-rebind","jquery"],b):b(a.d3,a.fc,a.fc_rebind,a.$)}(this,function(a,b,c,d){"use strict";function e(){function c(b){b.each(function(b){var c=a.select(this),g=c.select("#tooltip");d=b.product.priceFormat,e=b.product.volumeFormat,f=b.period.timeFormat,c.classed("hidden",!b.data),g.layout({flexDirection:"row"}).selectAll(".tooltip").layout({marginRight:40,marginLeft:15}),b.data&&g.datum(b.data).call(h)})}var d,e,f,g="0.71em",h=b.chart.tooltip().items([["T",function(a){return f(a.date)}],["O",function(a){return d(a.open)}],["H",function(a){return d(a.high)}],["L",function(a){return d(a.low)}],["C",function(a){return d(a.close)}],["V",function(a){return e(a.volume)}]]).decorate(function(a){a.enter().selectAll("text").attr("dy",g)});return c}function f(a,c,d,e){var f=b.util.extent().fields(["date"])(d),g=b.util.extent().fields([b.util.fn.identity])(c),h=a.distance(g[0],g[1]);if(e.getTime()<f[0]||e.getTime()>f[1])return g;var i=[a.offset(e,-h/2),a.offset(e,h/2)],j=0;return i[1].getTime()>f[1].getTime()?j=-a.distance(f[1],i[1]):i[0].getTime()<f[0].getTime()&&(j=a.distance(i[0],f[0])),[a.offset(i[0],j),a.offset(i[1],j)]}function g(b,c){var d=a.min(b,function(a){return a.getTime()}),e=a.max(b,function(a){return a.getTime()}),f=c.sort(function(a,b){return a.date-b.date}),g=a.bisector(function(a){return a.date}),h=c.slice(
// Pad and clamp the bisector values to ensure extents can be calculated
Math.max(0,g.left(f,d)-1),Math.min(g.right(f,e)+1,f.length));return h}function h(a,c,d,e){arguments.length<4&&(e=1);
// Ensure the earlier data is first in the array
var f=b.util.extent().fields([b.util.fn.identity])(c),g=b.util.extent().fields([b.util.fn.identity])(d),h=a.distance(g[0],g[1]),i=e*a.distance(f[0],f[1]),j=h>i?[a.offset(g[1],-i),g[1]]:g;return j}function i(b,c){var d=a.max(b,function(a){return a.getTime()}),e=a.max(c,function(a){return a.date.getTime()});return d===e}function j(a,c){a.secondaries.style("flex",c.secondaries().charts().length),a.overlaySecondaries.style("flex",c.secondaries().charts().length);var d=parseInt(a.app.select(".head-row").style("height"),10);wa||(d+=parseInt(a.app.select(".head-row").style("padding-top"),10)+parseInt(a.app.select(".head-row").style("padding-bottom"),10)+parseInt(a.app.select(".head-row").style("margin-bottom"),10),wa=!0);var e=b.util.innerDimensions(a.app.node()).height-d;a.chartsAndOverlay.style("height",e+"px"),c.xAxis().dimensionChanged(a.xAxis),c.nav().dimensionChanged(a.navbar),c.primary().dimensionChanged(a.primary),c.secondaries().charts().forEach(function(b){b.option.dimensionChanged(a.secondaries)})}function k(){return++xa}function l(a){return d(a).width()}
...
function n(a,b,c){var d,e,f=null,g=0;c||(c={});var h=function(){g=c.leading===!1?0:(new Date).getTime(),f=null,e=a.apply(this,d),f||(d=null)};return function(){var i=(new Date).getTime();g||c.leading!==!1||(g=i);var j=b-(i-g);return d=arguments,0>=j||j>b?(f&&(clearTimeout(f),f=null),g=i,e=a.apply(this,d),f||(d=null)):f||c.trailing===!1||(f=setTimeout(h.bind(this),j)),e}}function o(b){function c(a){
// If zooming, and about to pan off screen, do nothing
return a[0]>0&&a[1]<0}function d(){l.translate([0,0]),l.scale(1)}function e(a,b,c){return Math.min(Math.max(a,b),c)}function f(b,c){var d=b;return h(j[0])>0&&(d[1]=h.invert(h(b[1])+h(j[0]))),d[0]=a.max([c[0],d[0]]),d[1]=a.min([c[1],d[1]]),d}function g(g){var p=h(j[0]),q=h(j[1]),r=[p,q-b];l.x(h).on("zoom",function(){var b=a.event.translate,g=b[0],p=c(r);g=e(g,-r[1],-r[0]),l.translate([g,0]);var q=1===l.scale(),s=1!==l.scale();if(q&&m||s&&n){var t=h.domain();p?t=j:s&&o&&(t=ya.domain.moveToLatest(i,t,j)),t=f(t,j),t[0].getTime()!==t[1].getTime()?k.zoom(t):
// Ensure the user can't zoom-in infinitely, causing the chart to fail to render
// #168, #411
d()}else d()}),g.call(l).on("dblclick.zoom",null)}var h,i,j,k=a.dispatch("zoom"),l=a.behavior.zoom(),m=!0,n=!0,o=!0;return g.allowPan=function(a){return arguments.length?(m=a,g):m},g.allowZoom=function(a){return arguments.length?(n=a,g):n},g.trackingLatest=function(a){return arguments.length?(o=a,g):o},g.scale=function(a){return arguments.length?(h=a,g):h},g.discontinuityProvider=function(a){return arguments.length?(i=a,g):i},g.dataDateExtent=function(a){return arguments.length?(j=a,g):j},a.rebind(g,k,"on"),g}function p(a,b,c){return arguments.length<3&&(c=1),Math.max(Math.ceil(a/b),c)}function q(){function c(a,b){a.select(".plot-area").selectAll(".e, .w").classed("hidden",b)}function d(a){return a.extent()[0]-a.extent()[1]===0}function e(a,c){var d=a.selectAll("defs").data([0]).enter().append("defs");d.html('<linearGradient id="brush-gradient" x1="0" x2="0" y1="0" y2="1">               <stop offset="0%" class="brush-gradient-top" />               <stop offset="100%" class="brush-gradient-bottom" />           </linearGradient>           <mask id="brush-mask">               <rect class="mask-background"></rect>           </mask>'),a.select(".mask-background").attr({width:g,height:j}),u.domain(b.util.extent().fields(["date"])(c)),v.domain(b.util.extent().fields(["low","high"]).pad(r)(c)),a.select("mask").datum(c).call(F)}function f(a){var f=a.datum();E.bucketSize(Math.max(f.data.length/s,1));var h=E(f.data);u.discontinuityProvider(f.discontinuityProvider),x.discontinuityProvider(f.discontinuityProvider),e(a,h),x.domain(f.viewDomain);var i=ya.domain.filterDataInDateRange(b.util.extent().fields(["date"])(h),h),j=b.util.extent().fields(["low","high"]).pad(r)(i);w.xDomain(b.util.extent().fields(["date"])(h)).yDomain(j).xTicks(p(g,100,2)),A.on("brush",function(){var b=d(A);
// Hide the bar if the extent is empty
c(a,b),b||t[ua.viewChange](A.extent())}).on("brushend",function(){var b=d(A);c(a,!1),b&&t[ua.viewChange](ya.domain.centerOnDate(f.discontinuityProvider,x.domain(),f.data,A.extent()[0]))}),w.plotArea(B),a.datum({data:h}).call(w);
// Allow to zoom using mouse, but disable panning
var k=o(g).scale(x).trackingLatest(f.trackingLatest).discontinuityProvider(f.discontinuityProvider).dataDateExtent(b.util.extent().fields(["date"])(f.data)).allowPan(!1).on("zoom",function(a){t[ua.viewChange](a)});a.select(".plot-area").call(k)}var g,h=100,i=40,j=h-i,k=1,l=j-k,m=l,n=k+m/2,q=2,r=[0,.04],s=200,t=a.dispatch(ua.viewChange),u=b.scale.dateTime(),v=a.scale.linear(),w=b.chart.cartesian(u,v).yTicks(0).margin({bottom:i}).xOuterTickSize(0).yOuterTickSize(0),x=b.scale.dateTime(),y=b.series.area().xValue(function(a){return a.date}).y1Value(function(a){return a.close}).y0Value(function(){return v.domain()[0]}),z=b.series.line().xValue(function(a){return a.date}).yValue(function(a){return a.close}),A=a.svg.brush(),B=b.series.multi().series([y,z,A]).decorate(function(a){var b=a.enter();a.selectAll(".background, .extent").attr("height",l).attr("y",k),
// overload d3 styling for the brush handles
// as Firefox does not react properly to setting these through less file.
b.selectAll(".resize.w>rect, .resize.e>rect").attr("width",q).attr("x",-q/2),a.selectAll(".resize.w>rect, .resize.e>rect").attr("height",m).attr("y",k),b.select(".extent").attr("mask",'url("#brush-mask")');
// Adds the handles to the brush sides
var c=b.selectAll(".e, .w");c.append("circle").attr("cy",n).attr("r",7).attr("class","outer-handle"),c.append("circle").attr("cy",n).attr("r",4).attr("class","inner-handle")}).mapping(function(a){return a===A?(A.y(null).extent(x.domain()),null):this.data}),C=b.series.area().xValue(function(a){return a.date}).y1Value(function(a){return a.close}).y0Value(function(){return v.domain()[0]}).decorate(function(a){a.enter().attr("fill",'url("#brush-gradient")')}),D=b.series.line().xValue(function(a){return a.date}).yValue(function(a){return a.close}),E=b.data.sampler.largestTriangleThreeBucket().x(function(a){return u(a.date)}).y(function(a){return v(a.close)}),F=b.series.multi().series([C,D]).xScale(u).yScale(v);return a.rebind(f,t,"on"),f.dimensionChanged=function(a){g=ya.width(a.node()),x.range([0,g]),u.range([0,g]),v.range([j,0])},f}function r(a,b){var c=b/2;return[[0,0],[c,-c],[a,-c],[a,c],[c,c],[0,0]]}function s(a,b){for(var c=a.ticks.apply(a,[]),d=a.domain(),e=0;e<b.length;e++)b[e]>d[0]&&b[e]<d[1]&&c.push(b[e]);return c}function t(a){return a.reduce(function(a,b){return b.extentAccessor?a.concat(b.extentAccessor):a},[])}function u(){function c(){var a=[v,j.option,w],b=p.map(function(a){return a.option});return a.concat(b,u)}function d(){switch(B.value(n),C.value(n),w.value(n),j.valueString){case"line":case"point":j.option.yValue(n);break;case"area":j.option.yValue(n),j.option.y0Value(function(){return z.domain()[0]})}}
// Call when what to display on the chart is modified (ie series, options)
function e(a){j=a.series,n=a.yValueAccessor.option,p=a.indicators,d(),x.series(c()),A.yTickFormat(a.product.priceFormat),a.selectorsChanged=!1}function f(a){var b=j.option.width(a);u.decorate(function(a){a.classed("band",!0),a.selectAll(".vertical > line").style("stroke-width",b)})}function g(a){a.classed("band",!1).selectAll("line").style("stroke-width",null)}function h(a){"candlestick"===j.valueString||"ohlc"===j.valueString?f(a):u.decorate(g)}function i(c){var d=c.datum();d.selectorsChanged&&e(d),A.xDomain(d.viewDomain),y.discontinuityProvider(d.discontinuityProvider),u.snap(b.util.seriesPointSnapXOnly(j.option,d.visibleData)),h(d.visibleData),B(d.data),C(d.data);
// Scale y axis
// Add percentage padding either side of extreme high/lows
var f=t(x.series()),g=b.util.extent().fields(f).pad(.08)(d.visibleData);A.yDomain(g);
// Find current tick values and add close price to this list, then set it explicitly below
var i=n(d.data[d.data.length-1]),p=s(z,[i]);A.yTickValues(p).yDecorate(function(b){var c=b.selectAll(".tick").filter(function(a){return a===i}).classed("close-line",!0),d=18;c.select("path").attr("d",function(){return a.svg.area()(r(l,d))}),c.select("text").attr("transform","translate("+d/2+",1)")});var q=z.ticks.apply(z,[]);v.yTickValues(q),
// Redraw
A.plotArea(x),c.call(A);var w=o(k).scale(y).trackingLatest(d.trackingLatest).discontinuityProvider(d.discontinuityProvider).dataDateExtent(b.util.extent().fields(["date"])(d.data)).on("zoom",function(a){m[ua.viewChange](a)});c.select(".plot-area").call(w)}var j,k,l=60,m=a.dispatch(ua.viewChange,ua.crosshairChange),n=function(a){return a.close},p=[],q=[],u=b.tool.crosshair().xLabel("").yLabel("").on("trackingmove",function(a){a.length>0?m.crosshairChange(a[0].datum):m.crosshairChange(void 0)}).on("trackingend",function(){m.crosshairChange(void 0)});u.id=ya.uid();var v=b.annotation.gridline().xTicks(0),w=b.annotation.line().orient("horizontal").value(n).label("").decorate(function(a){a.classed("close-line",!0)});w.id=ya.uid();var x=b.series.multi().key(function(a){return a.id}).mapping(function(a){switch(a){case w:return[this.data[this.data.length-1]];case u:return q;default:return this.visibleData}}).decorate(function(a){a.enter().select(".area").attr("fill",'url("#primary-area-series-gradient")')}),y=b.scale.dateTime(),z=a.scale.linear(),A=b.chart.cartesian(y,z).xTicks(0).yOrient("right").margin({top:0,left:0,bottom:0,right:l}).decorate(function(a){a.enter().selectAll("defs").data([0]).enter().append("defs").html('<linearGradient id="primary-area-series-gradient" x1="0%" x2="0%" y1="0%" y2="100%">                       <stop offset="0%" class="primary-area-series-gradient-top" />                       <stop offset="100%" class="primary-area-series-gradient-bottom" />                   </linearGradient>')}),B=b.indicator.algorithm.movingAverage(),C=b.indicator.algorithm.bollingerBands();
// Call when the main layout is modified
return a.rebind(i,m,"on"),i.dimensionChanged=function(a){k=ya.width(a.node())-l},i}function v(){function c(a){return a.option.id}function d(b){b.each(function(b){var c=g(this,e);c.each(function(c){this.__secondaryChart__=c,c.option.on(ua.viewChange,f[ua.viewChange]),a.select(this).datum(b).call(c.option)})})}var e=[],f=a.dispatch(ua.viewChange),g=b.util.dataJoin().children(!0).selector(".secondary-container").element("svg").attr("class",function(a){return"secondary-container secondary-"+a.valueString}).key(function(a){
...
return c(this.__secondaryChart__||a)});return d.charts=function(a){return arguments.length?(e=a,d):e},a.rebind(d,f,"on"),d}function w(a,b,c,d){return{interval:a,step:b,duration:c,format:d}}
...
function x(){function b(a){return j.distance(a[0],a[1])}function c(a){var b=a[0],c=a[a.length-1];return c>b?[b,c]:[c,b]}function d(b,d){var e=c(b.map(function(a){return a/Fa})),f=e[1]-e[0],g=Math.pow(10,Math.floor(Math.log(f/d)/Math.LN10)),h=d/f*g;return.15>=h?g*=10:.35>=h?g*=5:.75>=h&&(g*=2),w(a.time.year,g,g*Fa,"%Y")}function e(){var a=-1;return null!=i&&2===i.length&&Ga.forEach(function(b,c){b.interval===i[0]&&b.step===i[1]&&(a=c)}),a}function f(c,f){var g,h=b(c),i=h/f,j=a.bisector(function(a){return a.duration}).right(Ga,i);if(j===Ga.length){g=d(c,f);for(
...
var k=f;h/g.duration>f&&k>=2&&f>0;)k-=1,g=d(c,k)}else{for(var l=j>0&&i/Ga[j-1].duration<Ga[j].duration/i?j-1:j;h/Ga[l].duration>f&&l<Ga.length-1;)l+=1;g=Ga[Math.max(l,e())]}return g}function g(){if(null!=i&&-1===e())throw new Error("Specified minimum tick interval is not supported");var a=c(h),b=f(a,null===k?10:k),d=b.interval,g=b.step,j=d.range(a[0],new Date(+a[1]+1),Math.max(1,g));// inclusive upper bound
return j.method=[d,g],j.format=b.format,j}var h,i,j,k=10;return g.domain=function(a){return arguments.length?(h=a,g):h},g.ticks=function(a){return arguments.length?(k=a,g):k},g.minimumTickInterval=function(a){return arguments.length?(i=a,g):i},g.discontinuityProvider=function(a){return arguments.length?(j=a,g):j},g}function y(){function c(c){var g=c.datum();d.domain(g.viewDomain).discontinuityProvider(g.discontinuityProvider);var h=2,i=100,j=p(d.range()[1],i,h),k=g.period,l=e.domain(d.domain()).discontinuityProvider(g.discontinuityProvider).ticks(j).minimumTickInterval([k.d3TimeInterval.unit,k.d3TimeInterval.value])();f.tickValues(b.scale.dateTime.tickTransformer(l,g.discontinuityProvider,g.viewDomain)).tickFormat(a.time.format(l.format)),c.call(f)}var d=b.scale.dateTime(),e=x(),f=b.svg.axis().scale(d).orient("bottom").decorate(function(b){b.selectAll("text").each(function(){var b=a.select(this),c=b.text().split(",");b.text(null),b.append("tspan").attr("class","axis-label-main").attr("x",0).text(c[0]),b.append("tspan").attr("class","axis-label-secondary").attr("dy","1.42em").attr("x",0).text(c[1])})});return c.dimensionChanged=function(a){d.range([0,ya.width(a.node())])},c}function z(){function b(a){a.each(function(b){a.select("#legend").datum(b.legend).call(d),a.select("#navbar-container").datum(b.nav).call(f),a.select("#primary-container").datum(b.primary).call(g),a.select("#secondaries-container").datum(b.secondary).call(h),a.select("#x-axis-container").datum(b.xAxis).call(i)})}var c=a.dispatch(ua.viewChange,ua.crosshairChange),d=e(),f=q().on(ua.viewChange,c[ua.viewChange]),g=u().on(ua.viewChange,c[ua.viewChange]).on(ua.crosshairChange,c[ua.crosshairChange]),h=v().on(ua.viewChange,c[ua.viewChange]),i=y();return b.legend=function(){return d},b.nav=function(){return f},b.primary=function(){return g},b.secondaries=function(){return h},b.xAxis=function(){return i},a.rebind(b,c,"on"),b}function A(a){return{displayString:a.display,option:a}}function B(a){return{displayString:a.display,option:a}}function C(){function c(a){var b=a.datum(),c=b.selectedIndex||0,i=b.config,j=e(a,[b.options]);if(i.icon){var k=j.selectAll(".icon").data([0]);k.enter().append("span"),k.attr("class","icon "+b.options[c].icon)}else j.select(".icon").remove(),j.text(function(){return i.title||b.options[c].displayString});f(j,i.careted?[0]:[]);var l=g(a,[b.options]),m=h(l,b.options),n=m.enter().on("click",d.optionChange).append("a").attr("href","#");n.append("span").attr("class","icon"),n.append("span").attr("class","name"),m.classed("selected",function(a,d){return b.selectedIndexes?b.selectedIndexes.indexOf(d)>-1:d===c}),m.selectAll(".icon").attr("class",function(a){return"icon "+a.icon}),m.selectAll(".name").text(function(a){return a.displayString})}var d=a.dispatch("optionChange"),e=b.util.dataJoin().selector("button").element("button").attr({"class":"dropdown-toggle",type:"button","data-toggle":"dropdown"}),f=b.util.dataJoin().selector(".caret").element("span").attr("class","caret"),g=b.util.dataJoin().selector("ul").element("ul").attr("class","dropdown-menu"),h=b.util.dataJoin().selector("li").element("li").key(function(a){return a.displayString});return a.rebind(c,d,"on"),c}function D(){function c(a){var c=a.datum().selectedIndex||0,f=e(a,[a.datum().options]);f.enter().append("ul");var g=f.selectAll("li").data(b.util.fn.identity);g.enter().append("li").append("a").attr("href","#").on("click",d.tabClick),g.classed("active",function(a,b){return b===c}).select("a").text(function(a){return a.displayString}),g.exit().remove()}var d=a.dispatch("tabClick"),e=b.util.dataJoin().selector("ul").element("ul");return a.rebind(c,d,"on"),c}function E(){var b=a.dispatch(ua.dataProductChange,ua.dataPeriodChange,ua.clearAllPrimaryChartIndicatorsAndSecondaryCharts),c=C().on("optionChange",b[ua.dataProductChange]),d=D().on("tabClick",b[ua.dataPeriodChange]),e=C().on("optionChange",b[ua.dataPeriodChange]),f=function(f){f.each(function(f){var g=a.select(this),h=f.products;g.select("#product-dropdown").datum({config:f.productConfig,options:h.map(A),selectedIndex:h.map(function(a){return a.id}).indexOf(f.selectedProduct.id)}).call(c);var i=f.selectedProduct.periods;g.select("#period-selector").classed("hidden",i.length<=1).datum({options:i.map(B),selectedIndex:i.indexOf(f.selectedPeriod)}).call(d),g.select("#mobile-period-selector").classed("hidden",i.length<=1).datum({config:f.mobilePeriodConfig,options:i.map(B),selectedIndex:i.indexOf(f.selectedPeriod)}).call(e),g.select("#clear-indicators").on("click",b[ua.clearAllPrimaryChartIndicatorsAndSecondaryCharts])})};return a.rebind(f,b,"on"),f}function F(){var b=a.dispatch(ua.primaryChartSeriesChange,ua.primaryChartIndicatorChange,ua.secondaryChartChange),c=C().on("optionChange",b[ua.primaryChartSeriesChange]),d=C().on("optionChange",function(a){a.isPrimary?b[ua.primaryChartIndicatorChange](a):b[ua.secondaryChartChange](a)}),e=function(b){b.each(function(b){var e=a.select(this),f=b.seriesSelector.options.map(function(a){return a.isSelected}).indexOf(!0);e.select(".series-dropdown").datum({config:b.seriesSelector.config,options:b.seriesSelector.options,selectedIndex:f}).call(c);var g=b.indicatorSelector.options,h=g.reduce(function(a,b,c){return b.isSelected?a.concat(c):a},[]);e.select(".indicator-dropdown").datum({config:b.indicatorSelector.config,options:g,selectedIndexes:h}).call(d)})};return a.rebind(e,b,"on"),e}function G(){function b(a){var b=a.datum(),d=a.selectAll("g").data([b]),e=d.enter().append("g").attr("class","reset-button").on("click",c[ua.resetToLatest]);e.append("path").attr("d","M1.5 1.5h13.438L23 20.218 14.937 38H1.5l9.406-17.782L1.5 1.5z"),e.append("rect").attr({width:5,height:28,x:26,y:6}),d.classed("hidden",b.trackingLatest)}var c=a.dispatch(ua.resetToLatest);return a.rebind(b,c,"on"),b}function H(){function b(b){b.each(function(b){var d=a.select(this),e=d.selectAll("div").data(b.selectedIndicators,function(a){return a.valueString}),f=e.enter().append("div").attr("class","edit-indicator");f.append("span").attr("class","icon bf-icon-delete").on("click",c.indicatorChange),f.append("span").attr("class","indicator-label").text(function(a){return a.displayString}),e.exit().remove()})}var c=a.dispatch(ua.indicatorChange);return a.rebind(b,c,"on"),b}function I(){var c=a.dispatch(ua.primaryChartIndicatorChange,ua.secondaryChartChange,ua.dataProductChange),d=H().on(ua.indicatorChange,c[ua.primaryChartIndicatorChange]),e=H().on(ua.indicatorChange,c[ua.secondaryChartChange]),f=C().on("optionChange",c[ua.dataProductChange]),g=b.util.dataJoin().selector(".overlay-secondary-container").element("div").attr("class","overlay-secondary-container").key(function(a){return a.displayString}),h=function(b){b.each(function(b){var c=a.select(this),h=b.products;c.select("#mobile-product-dropdown").datum({config:b.productConfig,options:h.map(A),selectedIndex:h.map(function(a){return a.id}).indexOf(b.selectedProduct.id)}).call(f),c.select("#overlay-primary-container .edit-indicator-container").datum({selectedIndicators:b.primaryIndicators}).call(d);var i=c.select("#overlay-secondaries-container"),j=g(i,b.secondaryIndicators),k=j.enter().append("div").attr("class","edit-indicator-container");k.each(function(b){a.select(this).datum({selectedIndicators:[b]}).call(e)})})};return a.rebind(h,c,"on"),h}function J(){function a(a){var c=++b;return function(d,e){b>c||a(d,e)}}var b=0;return a.invalidateCallback=function(){return b++,a},a}function K(){function b(a){var b=1e3*f;return new Date(Math.floor(a.getTime()/b)*b)}var c=function(a){return a.date},d=function(a){return Number(a.volume)},e=function(a){return Number(a.price)},f=60,g=function(f,g){var h=b(c(g)),i=e(g),j=d(g),k=a.bisector(function(a){return a.date}).left,l=f.filter(function(a){return a.date.getTime()===h.getTime()})[0];l?(l.high=Math.max(i,l.high),l.low=Math.min(i,l.low),l.close=i,l.volume+=j):f.splice(k(f,h),0,{date:h,open:i,high:i,low:i,close:i,volume:j})};return g.granularity=function(a){return arguments.length?(f=a,g):f},g.price=function(a){return arguments.length?(e=a,g):e},g.volume=function(a){return arguments.length?(d=a,g):d},g.date=function(a){return arguments.length?(c=a,g):c},g}function L(){function b(){f&&f.streamingFeed&&f.streamingFeed.close(),k=[],i.invalidateCallback()}function c(a){return a.sort(function(a,b){return a.date-b.date})}function d(){null!=f.streamingFeed&&(f.streamingFeed.on("message",function(a){h(k,a),g[ua.newTrade](k,f)}).on("error",function(a){g[ua.streamingFeedError](a,f)}).on("close",function(a){g[ua.streamingFeedClose](a,f)}),f.streamingFeed())}function e(a,e){b(),2===arguments.length&&(f=e.source,f.historicFeed.product(e.id),null!=f.streamingFeed&&f.streamingFeed.product(e.id));var l=new Date;f.historicFeed.end(l).candles(j).granularity(a),h.granularity(a),f.historicFeed(i(function(a,b){a?g[ua.historicFeedError](a,f):(k=c(b),g[ua.historicDataLoaded](k,f),d())}))}var f,g=a.dispatch(ua.newTrade,ua.historicDataLoaded,ua.historicFeedError,ua.streamingFeedError,ua.streamingFeedClose),h=K().date(function(a){return new Date(a.time)}).volume(function(a){return Number(a.size)}),i=J(),j=200,k=[];return e.candlesOfData=function(a){return arguments.length?(j=a,e):j},a.rebind(e,g,"on"),e}function M(){var c=a.dispatch(ua.notificationClose),d=b.util.dataJoin().selector("div.alert-content").element("div").attr("class","alert-content"),e=b.util.dataJoin().selector("div.alert").element("div").attr({"class":"alert alert-info alert-dismissible",role:"alert"}).key(function(a){return a.id}),f=function(b){b.each(function(b){var f=a.select(this),g=d(f,[b]);g.enter().html('<div class="messages"></div>');var h=e(g.select(".messages"),b.messages),i=h.enter();i.html('<button type="button" class="close" aria-label="Close">                     <span aria-hidden="true">&times;</span>                 </button>                 <span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span>                 <span class="sr-only">Error:</span>                 <span class="message"></span>'),i.select(".close").on("click",function(a){c[ua.notificationClose](a.id)}),h.select(".message").text(function(a){return a.message})})};return a.rebind(f,c,"on"),f}function N(a){return{id:ya.uid(),message:a}}function O(b,c,d,e){return{display:b||"1 day",seconds:c||86400,d3TimeInterval:d||{unit:a.time.day,value:1},timeFormat:a.time.format(e||"%b %d")}}function P(b,c,d,e,f,g){return{id:b,display:c||"Unspecified Product",priceFormat:a.format(g||".2f"),volumeFormat:a.format(f||".2f"),periods:d||[],source:e}}function Q(a,b,c,d,e){return{historicFeed:a,historicNotificationFormatter:b,streamingFeed:c,streamingNotificationFormatter:d,discontinuityProvider:e}}function R(a){var b;if(a.wasClean===!1&&1e3!==a.code&&1006!==a.code){var c=a.reason||"Unkown reason.";b="Disconnected from live stream: "+a.code+" "+c}return b}function S(a){var b;
// The WebSocket's error event doesn't contain much useful information,
// so the close event is used to report errors instead
return"error"===a.type&&a.message?b="Live stream error: "+a.message:"close"===a.type&&(b=R(a)),b}function T(a,b,c,d){return{title:a||null,careted:b||!1,listIcons:c||!1,icon:d||!1}}function U(a,b,c){return{productConfig:T(null,!0),mobilePeriodConfig:T(),products:a,selectedProduct:b,selectedPeriod:c,alertMessages:[],primaryIndicators:[],secondaryIndicators:[]}}function V(a,b){return{primaryIndicators:[],secondaryIndicators:[],productConfig:T(),products:a,selectedProduct:b}}function W(a,b,c,d,e){return{displayString:a,// TODO: is 'displayName' better?
valueString:b,// TODO: is this an id?
option:c,// TODO: Ideally, remove.
isSelected:!1,icon:d,isPrimary:e}}function X(a,b){return{config:a,options:b}}function Y(a,b,c,d,e){return{legend:a,nav:b,primary:c,secondary:d,xAxis:e}}function Z(a,b){return{data:void 0,product:a,period:b}}function $(a){return{data:[],viewDomain:[],trackingLatest:!0,discontinuityProvider:a}}function _(){return{trackingLatest:!0}}function aa(){var c=b.scale.dateTime(),d=a.scale.linear(),e=b.util.fractionalBarWidth(.75),f=function(a){return a.date},g=function(a,b){return c(f(a,b))},h=function(a){return a.low},i=function(a){return a.high},j=function(a){return a.close},k=b.svg.candlestick().x(function(a){return c(a.date)}).open(function(a){return d(a.open)}).high(function(a){return d(i(a))}).low(function(a){return d(h(a))}).close(function(a){return d(a.close)}),l=b.util.dataJoin().selector("path.up").element("path").attr("class","up"),m=b.util.dataJoin().selector("path.down").element("path").attr("class","down"),n=function(a){a.each(function(a){k.width(e(a.map(g)));var b=a.filter(function(a){return a.open<a.close}),c=a.filter(function(a){return a.open>=a.close});l(this,[b]).attr("d",k),m(this,[c]).attr("d",k)})};return n.xScale=function(a){return arguments.length?(c=a,n):c},n.yScale=function(a){return arguments.length?(d=a,n):d},n.xValue=function(a){return arguments.length?(f=a,n):f},n.yLowValue=function(a){return arguments.length?(h=a,n):h},n.yHighValue=function(a){return arguments.length?(i=a,n):i},n.yCloseValue=function(a){return arguments.length?(j=a,n):j},n.width=function(a){return e(a.map(g))},n}function ba(a,b){var c={data:[],visibleData:[],trackingLatest:!0,viewDomain:[],selectorsChanged:!0,discontinuityProvider:b},d=a;Object.defineProperty(c,"product",{get:function(){return d},set:function(a){d=a,c.selectorsChanged=!0}});var e=aa();e.id=ya.uid();var f=W("Candlestick","candlestick",e);f.option.extentAccessor=["high","low"],Object.defineProperty(c,"series",{get:function(){return f},set:function(a){f=a,c.selectorsChanged=!0}});var g={option:function(a){return a.close}};Object.defineProperty(c,"yValueAccessor",{get:function(){return g},set:function(a){g=a,c.selectorsChanged=!0}});var h=[];return Object.defineProperty(c,"indicators",{get:function(){return h},set:function(a){h=a,c.selectorsChanged=!0}}),c}function ca(a,b){return{data:[],visibleData:[],viewDomain:[],trackingLatest:!0,product:a,discontinuityProvider:b,indicators:[]}}function da(a,b){return{viewDomain:[],period:a,discontinuityProvider:b}}function ea(){return{messages:[]}}function fa(){function c(c){c.each(function(c){f.discontinuityProvider(c.discontinuityProvider);var g=a.select(this).datum(c.visibleData).call(k),i=o(d).scale(f).trackingLatest(h).discontinuityProvider(c.discontinuityProvider).dataDateExtent(b.util.extent().fields(["date"])(c.data)).on("zoom",function(a){e[ua.viewChange](a)});g.select(".plot-area-container").call(i)})}var d,e=a.dispatch(ua.viewChange),f=b.scale.dateTime(),g=a.scale.linear(),h=!0,i=60,j=b.series.multi(),k=b.chart.cartesian(f,g).plotArea(j).xTicks(0).yOrient("right").margin({top:0,left:0,bottom:0,right:i});return c.trackingLatest=function(a){return arguments.length?(h=a,c):h},a.rebind(c,e,"on"),a.rebind(c,j,"series","mapping","decorate"),a.rebind(c,k,"yTickValues","yTickFormat","yTicks","xDomain","yDomain"),c.dimensionChanged=function(a){d=ya.width(a.node())-i},c}function ga(){function c(a){var c=a.datum();g(c.data);var d=b.util.extent().fields(["macd"]).symmetricalAbout(0).pad(.08)(c.data.map(function(a){return a.macd}));h.trackingLatest(c.trackingLatest).xDomain(c.viewDomain).yDomain(d),a.call(h)}var d=a.dispatch(ua.viewChange),e=b.annotation.line().value(0).label(""),f=b.indicator.renderer.macd(),g=b.indicator.algorithm.macd(),h=fa().series([e,f]).yTicks(5).mapping(function(a){return a===e?[0]:this}).decorate(function(a){a.enter().attr("class",function(a,b){return["multi zero","multi"][b]})}).on(ua.viewChange,function(a){d[ua.viewChange](a)});return a.rebind(c,d,"on"),c.dimensionChanged=function(a){h.dimensionChanged(a)},c}function ha(){function c(a){var b=a.datum();f(b.data),h.trackingLatest(b.trackingLatest).xDomain(b.viewDomain).yDomain([0,100]),a.call(h)}var d=a.dispatch(ua.viewChange),e=b.indicator.renderer.relativeStrengthIndex(),f=b.indicator.algorithm.relativeStrengthIndex().value(function(a){return a.close}),g=[e.lowerValue(),50,e.upperValue()],h=fa().series([e]).yTickValues(g).on(ua.viewChange,function(a){d[ua.viewChange](a)});return a.rebind(c,d,"on"),c.dimensionChanged=function(a){h.dimensionChanged(a)},c}function ia(){function c(a){a.each(function(c){var d=b.util.extent().fields(["volume"]).pad(.08)(c.data);d[0]<0&&(d[0]=0),f.yTickFormat(c.product.volumeFormat).trackingLatest(c.trackingLatest).xDomain(c.viewDomain).yDomain(d),a.call(f)})}var d=a.dispatch(ua.viewChange),e=b.series.bar().xValue(function(a){return a.date}).yValue(function(a){return a.volume}),f=fa().series([e]).yTicks(4).on(ua.viewChange,function(a){d[ua.viewChange](a)});return a.rebind(c,d,"on"),c.dimensionChanged=function(a){f.dimensionChanged(a)},c}function ja(){var c,d,e,f=b.data.random.financial(),g=[86400],h=null,i=function(b){d.setHours(0,0,0,0);var e=a.time.day.offset(d,-(c-1));f.startDate(e);var g=f(c);b(null,g)};return i.candles=function(a){return arguments.length?(c=a,i):c},i.end=function(a){return arguments.length?(d=a,i):d},i.granularity=function(a){if(!arguments.length)return e;if(-1===g.indexOf(a))throw new Error("Granularity of "+a+" is not supported. Random Financial Data Generator only supports daily data.");return e=a,i},i.product=function(a){if(!arguments.length)return h;if("Data Generator"!==a)throw new Error("Random Financial Data Generator does not support products.");return h=a,i},i.apiKey=function(){throw new Error("Not implemented.")},i}function ka(){var c,d=1e3,e=b.data.feed.coinbase(),f=m(function(b){var d=a.time.second.offset(e.end(),-c*e.granularity());e.start(d),e(b)},d);return f.candles=function(a){return arguments.length?(c=a,f):c},f.apiKey=function(){throw new Error("Not implemented.")},a.rebind(f,e,"end","granularity","product"),f}function la(a){var b;return a&&(b=a.message),b}
// https://docs.exchange.coinbase.com/#websocket-feed
function ma(){var b,c="BTC-USD",d=a.dispatch("open","close","error","message"),e="match",f=function(a,f){a=a||"wss://ws-feed.exchange.coinbase.com",f=f||{type:"subscribe",product_id:c},b=new WebSocket(a),b.onopen=function(a){b.send(JSON.stringify(f)),d.open(a)},b.onerror=function(a){d.error(a)},b.onclose=function(a){d.close(a)},b.onmessage=function(a){var b=JSON.parse(a.data);b.type===e?d.message(b):"error"===b.type&&d.error(b)}};return a.rebind(f,d,"on"),f.close=function(){
// Only close the WebSocket if it is opening or open
!b||b.readyState!==WebSocket.CONNECTING&&b.readyState!==WebSocket.OPEN||b.close()},f.messageType=function(a){return arguments.length?(e=a,f):e},f.product=function(a){return arguments.length?(c=a,f):c},f}function na(){function d(a){var b=k.get(a);return b||(b=a[0].toLowerCase()+a.substr(1)),b}function e(a){return a.map(function(a){return a.date.setHours(0,0,0,0),a})}function f(b){var c=a.time.second.offset(i.end(),-h*g);i.start(c).collapse(j.get(g)),i(function(a,c){if(a)b(a);else{var d=e(c);b(a,d)}})}var g,h,i=b.data.feed.quandl().database("WIKI").columnNameMap(d),j=a.map();j.set(86400,"daily"),j.set(604800,"weekly");
// Map fields for WIKI database, to use all adjusted values
var k=a.map();return k.set("Open","unadjustedOpen"),k.set("High","unadjustedHigh"),k.set("Low","unadjustedLow"),k.set("Close","unadjustedClose"),k.set("Volume","unadjustedVolume"),k.set("Adj. Open","open"),k.set("Adj. High","high"),k.set("Adj. Low","low"),k.set("Adj. Close","close"),k.set("Adj. Volume","volume"),f.candles=function(a){return arguments.length?(h=a,f):h},f.granularity=function(a){if(!arguments.length)return g;if(!j.has(a))throw new Error("Granularity of "+a+" is not supported.");return g=a,f},c.rebindAll(f,i,c.includeMap({end:"end",dataset:"product",apiKey:"apiKey"})),f}function oa(a){var b;return a&&a.quandl_error&&(b=a.quandl_error.message),b}
// TODO: Temp until merged into d3fc
function pa(){function b(a){return 0===a.getDay()||6===a.getDay()}var c=864e5,d=5*c,e=7*c,f={};
...
return g=a.time.day.offset(g,7*l),h-=l*d,g=new Date(g.getTime()+h)},f.copy=function(){return f},f}function qa(){function c(){return{week1:Na.data.period("Weekly",604800,{unit:a.time.week,value:1},"%b %d"),day1:Na.data.period("Daily",86400,{unit:a.time.day,value:1},"%b %d"),hour1:Na.data.period("1 Hr",3600,{unit:a.time.hour,value:1},"%b %d %Hh"),minute5:Na.data.period("5 Min",300,{unit:a.time.minute,value:5},"%H:%M"),minute1:Na.data.period("1 Min",60,{unit:a.time.minute,value:1},"%H:%M")}}function d(){return{generated:Na.data.source(ja(),null,null,null,b.scale.discontinuity.identity()),bitcoin:Na.data.source(ka(),la,ma(),S,b.scale.discontinuity.identity()),quandl:Na.data.source(na(),oa,null,null,pa())}}function e(){return{generated:Na.data.product("Data Generator","Data Generator",[k.day1],l.generated,".3s"),quandl:Na.data.product("GOOG","GOOG",[k.day1],l.quandl,".3s")}}function f(){var a=aa();a.id=ya.uid();var c=Na.menu.option("Candlestick","candlestick",a,"bf-icon-candlestick-series");c.isSelected=!0,c.option.extentAccessor=["high","low"];var d=b.series.ohlc();d.id=ya.uid();var e=Na.menu.option("OHLC","ohlc",d,"bf-icon-ohlc-series");e.option.extentAccessor=["high","low"];var f=b.series.line().xValue(function(a){return a.date});f.id=ya.uid();var g=Na.menu.option("Line","line",f,"bf-icon-line-series");g.option.extentAccessor="close";var h=b.series.point().xValue(function(a){return a.date});h.id=ya.uid();var i=Na.menu.option("Point","point",h,"bf-icon-point-series");i.option.extentAccessor="close";var j=b.series.area().xValue(function(a){return a.date});j.id=ya.uid();var k=Na.menu.option("Area","area",j,"bf-icon-area-series");k.option.extentAccessor="close";var l=Na.menu.dropdownConfig(null,!1,!0,!0),m=[c,e,g,i,k];return Na.menu.selector(l,m)}function g(){var a=Pa.secondary,c=b.series.line().decorate(function(a){a.enter().classed("movingAverage",!0)}).xValue(function(a){return a.date}).yValue(function(a){return a.movingAverage});c.id=ya.uid();var d=Na.menu.option("Moving Average","movingAverage",c,"bf-icon-moving-average-indicator",!0);d.option.extentAccessor=function(a){return a.movingAverage};var e=b.indicator.renderer.bollingerBands();e.id=ya.uid();var f=Na.menu.option("Bollinger Bands","bollinger",e,"bf-icon-bollinger-bands-indicator",!0);f.option.extentAccessor=[function(a){return a.bollingerBands.lower},function(a){return a.bollingerBands.upper}];var g=a.rsi();g.id=ya.uid();var h=a.macd();h.id=ya.uid();var i=a.volume();i.id=ya.uid();var j=[d,f,Na.menu.option("Relative Strength Index","rsi",g,"bf-icon-rsi-indicator",!1),Na.menu.option("MACD","macd",h,"bf-icon-macd-indicator",!1),Na.menu.option("Volume","volume",i,"bf-icon-bar-series",!1)];return j}function h(){var a=Na.menu.dropdownConfig("Add Indicator",!1,!0);return Na.menu.selector(a,g())}function i(){return{seriesSelector:f(),indicatorSelector:h()}}function j(){var a=Na.chart.legend(m.generated,k.day1),b=Na.chart.nav(m.generated.source.discontinuityProvider),c=Na.chart.primary(m.generated,m.generated.source.discontinuityProvider),d=Na.chart.secondary(m.generated,m.generated.source.discontinuityProvider),e=Na.chart.xAxis(k.day1,m.generated.source.discontinuityProvider);return Na.chart.group(a,b,c,d,e)}var k=c(),l=d(),m=e();return{data:[],periods:k,sources:l,selectors:i(),navReset:Na.chart.navigationReset(),headMenu:Na.menu.head([m.generated,m.quandl],m.generated,k.day1),overlay:Na.menu.overlay([m.generated,m.quandl],m.generated),notificationMessages:Na.notification.messages(),charts:j()}}function ra(b){a.json("https://api.exchange.coinbase.com/products",function(a,c){return a?void b(a):void b(a,c)})}function sa(a,b,c,d){return a.map(function(a){return Na.data.product(a.id,a.id,d.get(a.id)||c,b)})}function ta(){function d(){Z&&(Z=!1),_&&I.suspendLayout(!1),I.chartsAndOverlay.datum(U.charts).call(W),I.app.select("#navbar-reset").datum(U.navReset).call(O),I.app.select(".head-menu").datum(U.headMenu).call(M),I.app.selectAll(".selectors").datum(U.selectors).call(P),I.app.select("#notifications").datum(U.notificationMessages).call(Q),I.overlay.datum(U.overlay).call(K),_&&(I.suspendLayout(!0),_=!1)}function e(){_=!0,ya.layout(I,W)}function f(){a.select(window).on("resize",function(){e(),$()})}function g(a){U.notificationMessages.messages.unshift(N(a))}function h(a){var b=[a[0],a[1]];U.charts.primary.viewDomain=b,U.charts.secondary.viewDomain=b,U.charts.xAxis.viewDomain=b,U.charts.nav.viewDomain=b;var c=ya.domain.filterDataInDateRange(b,U.data);U.charts.primary.visibleData=c,U.charts.secondary.visibleData=c;var d=ya.domain.trackingLatestData(U.charts.primary.viewDomain,U.charts.primary.data);U.charts.primary.trackingLatest=d,U.charts.secondary.trackingLatest=d,U.charts.nav.trackingLatest=d,U.navReset.trackingLatest=d,$()}function i(a){a.isSelected=!a.isSelected,B(),$()}function j(a){a.isSelected=!a.isSelected,D(),$()}function k(a){U.charts.legend.data=a,$()}function l(a,b){var c;c=b.streamingNotificationFormatter?b.streamingNotificationFormatter(a):S(a),c&&(g(c),$())}function m(){var a=U.charts.primary.data,c=b.util.extent().fields(["date"])(a),d=ya.domain.moveToLatest(U.charts.primary.discontinuityProvider,c,c,Y);h(d)}function n(a,b){var c='<div class="spinner"></div>',d=arguments.length>1||a,e="";b&&b.length&&(e='<div class="content alert alert-info">'+b+"</div>"),I.app.select("#loading-status-message").classed("hidden",!d).html(b?e:c)}function o(a){U.data=a,U.charts.primary.data=a,U.charts.secondary.data=a,U.charts.nav.data=a}function p(a){var b=a.discontinuityProvider;U.charts.xAxis.discontinuityProvider=b,U.charts.nav.discontinuityProvider=b,U.charts.primary.discontinuityProvider=b,U.charts.secondary.discontinuityProvider=b}function q(a){U.headMenu.selectedProduct=a,U.overlay.selectedProduct=a,U.charts.primary.product=a,U.charts.secondary.product=a,U.charts.legend.product=a,p(a.source)}function r(a){U.headMenu.selectedPeriod=a,U.charts.xAxis.period=a,U.charts.legend.period=a}function s(a){n(!0),q(a),r(a.periods[0]),V(a.periods[0].seconds,a)}function t(){return z().on(ua.crosshairChange,k).on(ua.viewChange,h)}function u(){return Ha.navigationReset().on(ua.resetToLatest,m)}function v(){return L().on(ua.newTrade,function(a){if(o(a),U.charts.primary.trackingLatest){var c=ya.domain.moveToLatest(U.charts.primary.discontinuityProvider,U.charts.primary.viewDomain,b.util.extent().fields(["date"])(U.charts.primary.data));h(c)}}).on(ua.historicDataLoaded,function(a){n(!1),o(a),U.charts.legend.data=null,m(),e()}).on(ua.historicFeedError,function(a,b){if(J){var c=J(a)||!0;n(!1,c)}else{n(!1,"Error loading data. Please make your selection again, or refresh the page.");var d="";try{var e=JSON.parse(a.responseText),f=b.historicNotificationFormatter(e);f&&(d=". "+f)}catch(h){d=""}var i=a.statusText||"Unknown reason.",j="Error getting historic data: "+i+d;g(j)}$()}).on(ua.streamingFeedError,l).on(ua.streamingFeedClose,l)}function w(){return Ha.head().on(ua.dataProductChange,function(a){s(a.option),$()}).on(ua.dataPeriodChange,function(a){n(!0),r(a.option),V(a.option.seconds),$()}).on(ua.clearAllPrimaryChartIndicatorsAndSecondaryCharts,function(){U.charts.primary.indicators.forEach(y),U.charts.secondary.indicators.forEach(y),B(),D(),$()})}function x(a,b){b.forEach(function(a){a.isSelected=!1}),a.isSelected=!0}function y(a){a.isSelected=!1}function A(){return Ha.selectors().on(ua.primaryChartSeriesChange,function(a){U.charts.primary.series=a,x(a,U.selectors.seriesSelector.options),$()}).on(ua.primaryChartIndicatorChange,i).on(ua.secondaryChartChange,j)}function B(){U.charts.primary.indicators=U.selectors.indicatorSelector.options.filter(function(a){return a.isSelected&&a.isPrimary}),U.overlay.primaryIndicators=U.charts.primary.indicators,U.headMenu.primaryIndicators=U.charts.primary.indicators}function C(){U.charts.secondary.indicators=U.selectors.indicatorSelector.options.filter(function(a){return a.isSelected&&!a.isPrimary}),W.secondaries().charts(U.charts.secondary.indicators.map(function(a){return a})),U.overlay.secondaryIndicators=U.charts.secondary.indicators,U.headMenu.secondaryIndicators=U.charts.secondary.indicators}function D(){C(),e()}function E(){return Ha.overlay().on(ua.primaryChartIndicatorChange,i).on(ua.secondaryChartChange,j).on(ua.dataProductChange,function(a){s(a.option),$()})}function F(a){U.notificationMessages.messages=U.notificationMessages.messages.filter(function(b){return b.id!==a}),$()}function G(){return Ia.toast().on(ua.notificationClose,F)}function H(b,c){if(b){var d=b.statusText||"Unknown reason.",e="Error retrieving Coinbase products: "+d;U.notificationMessages.messages.unshift(N(e))}else{var f=[U.periods.hour1,U.periods.day1],g=a.map();g.set("BTC-USD",[U.periods.minute1,U.periods.minute5,U.periods.hour1,U.periods.day1]);var h=sa(c,U.sources.bitcoin,f,g);U.headMenu.products=U.headMenu.products.concat(h),U.overlay.products=U.headMenu.products}$()}var I,J,K,M,O,P,Q,R='<div class="container-fluid">         <div id="notifications"></div>         <div id="loading-status-message"></div>         <div class="row head-menu head-row">             <div class="col-md-12 head-sub-row">                 <div id="product-dropdown" class="dropdown product-dropdown"></div>                 <div class="selectors">                     <div class="series-dropdown dropdown selector-dropdown"></div>                     <div class="indicator-dropdown dropdown selector-dropdown"></div>                     <div id="mobile-period-selector" class="dropdown"></div>                 </div>                 <div id="period-selector"></div>                 <span id="clear-indicators" class="icon bf-icon-delete delete-button"></span>             </div>         </div>         <div class="row primary-row">             <div id="charts" class="col-md-12">                 <div id="charts-container">                     <svg id="primary-container"></svg>                     <div id="secondaries-container"></div>                     <div class="x-axis-row">                         <svg id="x-axis-container"></svg>                     </div>                     <div id="navbar-row">                         <svg id="navbar-container"></svg>                         <svg id="navbar-reset"></svg>                     </div>                 </div>                 <div id="overlay">                     <div id="overlay-primary-container">                         <div id="overlay-primary-head">                             <div class="selectors">                                 <div id="mobile-product-dropdown" class="dropdown"></div>                                 <div class="series-dropdown dropdown selector-dropdown"></div>                                 <div class="indicator-dropdown dropdown selector-dropdown"></div>                             </div>                             <div id="legend">                                 <svg id="tooltip"></svg>                             </div>                         </div>                         <div id="overlay-primary-bottom">                             <div class="edit-indicator-container"></div>                         </div>                     </div>                     <div id="overlay-secondaries-container"></div>                     <div class="x-axis-row"></div>                     <div id="overlay-navbar-row"></div>                 </div>             </div>         </div>     </div>',T={},U=qa(),V=v(),W=t(),X=!1,Y=.2,Z=!0,$=b.util.render(d),_=!0;return T.fetchCoinbaseProducts=function(a){return arguments.length?(X=a,T):X},T.changeQuandlProduct=function(a){var b=Ja.product(a,a,[U.periods.day1],U.sources.quandl,".3s"),c=U.headMenu.products.some(function(a){return a.id===b.id}),d=U.overlay.products.some(function(a){return a.id===b.id});c||U.headMenu.products.push(b),d||U.overlay.products.push(b),s(b),Z||$()},T.proportionOfDataToDisplayByDefault=function(a){return arguments.length?(Y=a,T):Y},T.historicFeedErrorCallback=function(a){return arguments.length?(J=a,T):J},T.indicators=function(a){if(!arguments.length){var b=[];return U.selectors.indicatorSelector.options.forEach(function(a){a.isSelected&&b.push(a.valueString)}),b}return U.selectors.indicatorSelector.options.forEach(function(b){b.isSelected=a.some(function(a){return a===b.valueString})}),B(),Z?C():(D(),$()),T},T.run=function(b){if(!b)throw new Error("An element must be specified when running the application.");var c=a.select(b);c.html(R);var d=c.select("#charts"),g=c.select("#charts-container"),h=c.select("#overlay");I={app:c,charts:g,chartsAndOverlay:d,primary:g.select("#primary-container"),secondaries:g.select("#secondaries-container"),xAxis:g.select("#x-axis-container"),navbar:g.select("#navbar-container"),overlay:h,overlaySecondaries:h.select("#overlay-secondaries-container"),legend:c.select("#legend"),suspendLayout:function(a){var b=this;Object.keys(b).forEach(function(c){"function"!=typeof b[c]&&b[c].layoutSuspended(a)})}},M=w(),O=u(),P=A(),K=E(),Q=G(),e(),f(),V(U.headMenu.selectedPeriod.seconds,U.headMenu.selectedProduct),X?ra(H):U.sources.bitcoin&&delete U.sources.bitcoin},c.rebindAll(T,U.sources.quandl.historicFeed,c.includeMap({apiKey:"quandlApiKey"})),c.rebindAll(T,V,c.includeMap({candlesOfData:"periodsOfDataToFetch"})),T}a="default"in a?a["default"]:a,b="default"in b?b["default"]:b,c="default"in c?c["default"]:c,d="default"in d?d["default"]:d;var ua={crosshairChange:"crosshairChange",viewChange:"viewChange",newTrade:"newTrade",historicDataLoaded:"historicDataLoaded",historicFeedError:"historicFeedError",streamingFeedError:"streamingFeedError",streamingFeedClose:"streamingFeedClose",dataProductChange:"dataProductChange",dataPeriodChange:"dataPeriodChange",resetToLatest:"resetToLatest",clearAllPrimaryChartIndicatorsAndSecondaryCharts:"clearAllPrimaryChartIndicatorsAndSecondaryCharts",primaryChartSeriesChange:"primaryChartSeriesChange",primaryChartYValueAccessorChange:"primaryChartYValueAccessorChange",primaryChartIndicatorChange:"primaryChartIndicatorChange",secondaryChartChange:"secondaryChartChange",indicatorChange:"indicatorChange",notificationClose:"notificationClose"},va={centerOnDate:f,filterDataInDateRange:g,moveToLatest:h,trackingLatestData:i},wa=!1,xa=0,ya={domain:va,layout:j,uid:k,width:l,debounce:m,throttle:n},za=1e3,Aa=60*za,Ba=60*Aa,Ca=24*Ba,Da=7*Ca,Ea=30*Ca,Fa=365*Ca,Ga=[[a.time.second,1,za,"%H:%M,%d %b"],[a.time.second,5,5*za,"%H:%M,%d %b"],[a.time.second,15,15*za,"%H:%M,%d %b"],[a.time.second,30,30*za,"%H:%M,%d %b"],[a.time.minute,1,Aa,"%H:%M,%d %b"],[a.time.minute,5,5*Aa,"%H:%M,%d %b"],[a.time.minute,15,15*Aa,"%H:%M,%d %b"],[a.time.minute,30,30*Aa,"%H:%M,%d %b"],[a.time.hour,1,Ba,"%H:%M,%d %b"],[a.time.hour,3,3*Ba,"%H:%M,%d %b"],[a.time.hour,6,6*Ba,"%H:%M,%d %b"],[a.time.hour,12,12*Ba,"%H:%M,%d %b"],[a.time.day,1,Ca,"%a %d,%b %Y"],[a.time.week,1,Da,"%d %b,%Y"],[a.time.month,1,Ea,"%B,%Y"],[a.time.month,3,3*Ea,"%B,%Y"],[a.time.year,1,Fa,"%Y"]].map(function(a){return w.apply(this,a)}),Ha={head:E,selectors:F,navigationReset:G,overlay:I},Ia={toast:M},Ja={period:O,product:P,source:Q},Ka={head:U,periodAdaptor:B,productAdaptor:A,overlay:V,dropdownConfig:T,option:W,selector:X},La={group:Y,legend:Z,nav:$,navigationReset:_,primary:ba,secondary:ca,xAxis:da},Ma={message:N,messages:ea},Na={menu:Ka,chart:La,data:Ja,notification:Ma},Oa={base:fa,macd:ga,rsi:ha,volume:ia},Pa={legend:e,nav:q,primary:u,xAxis:y,secondary:Oa,multiChart:v,group:z},Qa={app:ta},Ra=window.location.search.split("seed=")[1];Ra&&Math.seedrandom(Ra),Qa.app().fetchCoinbaseProducts(!0).run("#app-container")});